...
async def save_photo(c,m):
    v = await m.reply_text("<b>Processing...⏳</b>",True)
    if m.media_group_id is not None:
        ...
        try:
           await v.edit_text("<b>✓ Succesfully Saved Thumbnail</b>")
...
async def show_thumbnail(c,m):
    ...
    if thumb_image_path is None:
        try:
            await msgg.edit_text("<b>No Thumbnail Found</b>")
        except:
              pass               
    else:
        try:
        ...
        caption="<b>This Is Your Saved Thumbnail</b>",
        quote=True
    )
